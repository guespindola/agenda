...
//echo "ID das pessoas que foram selecionadsa para o compromisso";
...
// consultando no banco o id do compromissos que foi registrado
$comRegistrado = "SELECT MAX(idCompromisso) as idCompromisso FROM compromissos";
$resultadoIdComp= mysqli_query($conexao,$comRegistrado);
