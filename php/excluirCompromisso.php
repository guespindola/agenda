...
$comandoPessoas="DELETE FROM compromissos_pessoas WHERE compromissos_idCompromisso=".$idCompromisso;

$comandoCompromisso="DELETE FROM compromissos WHERE idCompromisso=".$idCompromisso;
